...
import FormSearch from './InputSearch'


const Aside = ({ handleSearch, isLoading }) => {
        ...
        <Fragment>
            <aside className="aside">
                <div className="aside-container">
                    <header className="aside-header">
                        <a className="aside-link" href="#">
                            ...
                            {/* <svg className="aside-icon" viewBox="0 0 167.5 167.5">
                                <h1 className="aside-title">Lyrics Songs</h1>
                                <title>Lyrics Songs</title>
                    ...
                    <FormSearch handleSearch={handleSearch} isLoading={isLoading} />
